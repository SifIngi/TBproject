...
model = function (current_timepoint, state_values, parameters)
{
  ...
  IL2 = state_values [6]
  IFNg = state_values [7]
  IFNgk = state_values [8]
  TNFa = state_values [9]
  Dendrit = state_values [10]
  IL23 = state_values [11]
  Th17 = state_values [12]
  IL17 = state_values [13]
  GranulotcytKnoglemarv = state_values[14]
...
initial.values <- c(Vaccine = Vaccine0, Makrofag = Makrofag0, IL12 = IL120, Th0 = Th00, Th1 = Th10, IL2 = IL20, IFNg = IFNg0, 
