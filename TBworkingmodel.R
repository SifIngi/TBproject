...
plot(Th0_IL12~time,data=output,type='l',lwd=3,lty=2,col='black',xlim=c(0,800),ylim=c(0,100000),ylab='Amount',xlab='Time (days)',main="Th0_IL12")
plot(Th0_IL17~time,data=output,type='l',lwd=3,lty=2,col='black',xlim=c(0,100),ylim=c(0,1.1),ylab='Amount',xlab='Time (days)',main="Th0_IL17")
plot(Th1~time,data=output,type='l',lwd=3,lty=2,col='black',xlim=c(0,800),ylim=c(0,1000000),ylab='Amount',xlab='Time (days)',main="Th1")
plot(IL2~time,data=output,type='l',lwd=3,lty=2,col='black',xlim=c(0,800),ylim=c(0,1000000),ylab='Amount',xlab='Time (days)',main="IL2")
plot(IFNg~time,data=output,type='l',lwd=3,lty=2,col='black',xlim=c(0,800), ylim=c(0,6000000),ylab='Amount',xlab='Time (days)',main="IFNg")
plot(IFNgk~time,data=output,type='l',lwd=3,lty=2,col='black',xlim=c(0,800),ylim=c(0,5000000),ylab='Amount',xlab='Time (days)',main="IFNgk")
plot(TNFa~time,data=output,type='l',lwd=3,lty=2,col='black',ylim=c(0,500),ylab='Amount',xlab='Time (days)',main="TNFa")

plot(Dendrit~time,data=output,type='l',lwd=3,lty=2,col='black',ylim=c(0,2),xlim=c(0,10),ylab='Amount',xlab='Time (days)',main="Dendrit")
